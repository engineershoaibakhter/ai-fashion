    ...
    <div className={styles.contact_us}>
      <div className={styles.contactContainer} id='contact_us'>
        <div className={styles.leftSection}>
          ...
          <p>We would love to hear from you! Whether you have a question, feedback, or simply want to say hello, our team is here to help. Your thoughts and inquiries are important to us, and we are committed to providing you with the best possible support.</p>
